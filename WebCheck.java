...
//      iSource.setByteStream(styleFile);
    ...
    @Test
    public void allImgMustIncludeAllAttribute() {
    ...
    //@Test
    public void redLinksTurnGreen() {
        for (String sel : rulesMap.keySet()) {
            if (sel.startsWith("a") && sel.endsWith(":link")) {
                return;
            }
        }
        fail("Missing style for hyperlinks");
    }
    ...
    public static void main(String[] args) {
        if (args.length > 0) {
            ...
            JUnitCore.main("edu.gvsu.cs371.WebCheck");
        }
        else {
